...
import gal99 from "../assets/gal99.jpg";
...
const Gallery = () => {
  return (
   ...
   <img src={ gallery1 } alt="Amalia beauty thiruvalla" className='' />
   <img src={gal99} alt="Amalia beauty thiruvalla" className='' />
   ...
   <img src={card2} alt="Amalia beauty thiruvalla" className=' row-span-2 ' />
   ...
   <img src={g1} alt=" Amalia beauty thiruvalla" className=' ' />
   <img src={ g3} alt=" Amalia beauty thiruvalla" className=' ' />
   <img src={ g2} alt=" Amalia beauty thiruvalla" className=' ' />
  </div>
  <Footer />
    </div>
  )
